...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.common.permissions.user_permissions",
            ],
        },
    },
]
