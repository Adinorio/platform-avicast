    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "weather_conditions",
                    models.CharField(
                        blank=True, help_text="Weather during observation", max_length=200
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "species_name",
                    models.CharField(help_text="Common or scientific name", max_length=200),
                ),
                (
                    "count",
                ...
                (
                    "behavior_notes",
                    models.TextField(blank=True, help_text="Behavior, age, sex, etc."),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="locations.censusobservation",
                    ),
                ),
            ],
            options={
