...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        choices=[("MANUAL", "Manual"), ("IMAGE_PROCESSING", "Image Processing")],
                        max_length=20,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="sites", through="locations.BirdCensus", to="fauna.species"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="species",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="fauna.species"
            ),
        ),
        migrations.AddField(
            model_name="birdcensus",
