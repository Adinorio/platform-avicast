...
urlpatterns = [
    ...
    path(
        "analytics/results/<uuid:run_id>/",
        analytics_views.evaluation_results,
    ...
    path(
        ...
        analytics_views.create_evaluation_run,
        name="create_evaluation_run",
    ),
    path(
        "api/evaluation/status/<uuid:run_id>/",
        analytics_views.api_evaluation_status,
        name="api_evaluation_status",
    ),
    path(
        "api/evaluation/delete/<uuid:run_id>/",
        analytics_views.delete_evaluation_run,
        name="delete_evaluation_run",
    ),
    path(
        "api/evaluation/kfold/", analytics_views.api_kfold_evaluation, name="api_kfold_evaluation"
    ),
    path(
        "api/analytics/reviewed-summary/",
        analytics_views.api_reviewed_summary,
        name="api_reviewed_summary",
    ),
    # Debug
