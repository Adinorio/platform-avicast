...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--force", action="store_true", help="Force download even if models already exist"
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Starting YOLO model download..."))
        ...
        for version in models_to_download:
            if version not in yolo_models:
                self.stdout.write(self.style.WARNING(f"Unknown version: {version}"))
                continue
        ...
        if error_count > 0:
            ...
            self.stdout.write(self.style.WARNING("Check your internet connection and try again."))
