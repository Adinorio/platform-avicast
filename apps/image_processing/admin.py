...
from .models import ImageProcessingResult, ImageUpload, ProcessingBatch
...
class ImageUploadAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Upload Information", {"fields": ("title", "description", "image_file", "upload_status")}),
        (
            "File Details",
            {
                "fields": (
        ...
        ("User Information", {"fields": ("uploaded_by", "uploaded_at"), "classes": ("collapse",)}),
    )
    ...
    def processing_status(self, obj):
        if hasattr(obj, "processing_result"):
            ...
            if result.processing_status == "COMPLETED":
                ...
                return format_html(
                    '<span style="color: orange;">⏳ {}</span>', result.processing_status
                )
...
class ProcessingBatchAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Batch Information", {"fields": ("name", "description", "status")}),
        ("Progress Tracking", {"fields": ("total_images", "processed_images", "failed_images")}),
        ("Timing", {"fields": ("started_at", "completed_at"), "classes": ("collapse",)}),
        ("Images", {"fields": ("images",), "classes": ("collapse",)}),
        ("User Information", {"fields": ("created_by", "created_at"), "classes": ("collapse",)}),
    )
...
class ModelEvaluationRunAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Run Information", {"fields": ("name", "description", "status")}),
        (
        ...
        (
            "Date Filters",
            {"fields": ("date_range_start", "date_range_end"), "classes": ("collapse",)},
        ),
        (
            "Results",
            {
...
class ModelPerformanceMetricsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Model Information", {"fields": ("evaluation_run", "model_name", "model_version")}),
        (
            "Performance Metrics",
...
class SpeciesPerformanceMetricsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Species Information", {"fields": ("model_metrics", "species_name", "species_class_id")}),
        (
            "Performance Metrics",
            {"fields": ("precision", "recall", "f1_score", "average_precision")},
        ),
        ("Counts", {"fields": ("ground_truth_count", "detected_count"), "classes": ("collapse",)}),
        (
            "Confusion Matrix",
            {
                "fields": ("true_positives", "false_positives", "false_negatives"),
        ...
        ("Characteristics", {"fields": ("avg_confidence",), "classes": ("collapse",)}),
        ("Timestamps", {"fields": ("created_at",), "classes": ("collapse",)}),
    )
...
class ImageEvaluationResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Ground Truth",
            {"fields": ("ground_truth_boxes", "ground_truth_count"), "classes": ("collapse",)},
        ),
        (
            "Predictions",
            {"fields": ("predicted_boxes", "predicted_count"), "classes": ("collapse",)},
        ),
        (
            "Matching Results",
            {
