...
class ImageOptimizer:
    ...
    def optimize_for_ai(self, image_content):
        ...
        try:
            ...
            logger.info(
                f"AI optimization input: {original_width}x{original_height}, {original_size} bytes"
            )
            ...
            logger.info(
                f"AI optimization complete: {original_width}x{original_height} -> {ai_width}x{ai_height}, Bytes: {original_size} -> {ai_size}"
            )
    ...
    def optimize_image(self, image_content, target_format=None, max_dimensions=None, quality=None):
        ...
        try:
            ...
            logger.info(
                f"Image optimized: {target_format}, Size: {new_size} bytes, Quality: {quality}"
            )
    ...
    def batch_optimize(self, image_paths, output_directory, target_format=None):
        ...
        for image_path in image_paths:
            try:
                ...
                results.append({"original_path": image_path, "error": str(e)})
