    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Human-readable name for this evaluation run", max_length=200
                    ),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0.25,
                        help_text="Minimum confidence for detections",
                        max_digits=3,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Start date for filtered data", null=True
                    ),
                ),
                (
                    "date_range_end",
                    models.DateTimeField(
                        blank=True, help_text="End date for filtered data", null=True
                    ),
                ),
                (
                    "species_filter",
                    models.JSONField(default=list, help_text="Species included in evaluation"),
                ),
                ...
                (
                    "overall_map_50",
                    models.DecimalField(
                        blank=True, decimal_places=4, help_text="mAP@0.5", max_digits=6, null=True
                    ),
                ),
                (
                    "overall_map_50_95",
                ...
                (
                    "error_message",
                    models.TextField(blank=True, help_text="Error details if evaluation failed"),
                ),
                (
                    "processing_duration",
                    models.DurationField(
                        blank=True, help_text="Time taken to complete evaluation", null=True
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model_name",
                    models.CharField(help_text="Model variant name (e.g., yolov8l)", max_length=50),
                ),
                (
                    "model_version",
                    models.CharField(
                        blank=True, help_text="Specific model version or checkpoint", max_length=100
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="image_processing.modelevaluationrun",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image_filename",
                    models.CharField(help_text="Image filename for reference", max_length=255),
                ),
                (
                    "model_used",
                    models.CharField(help_text="Model variant used for this image", max_length=50),
                ),
                (
                    "ground_truth_boxes",
                    models.JSONField(default=list, help_text="List of ground truth bounding boxes"),
                ),
                ("ground_truth_count", models.IntegerField(default=0)),
                (
                    "predicted_boxes",
                    models.JSONField(default=list, help_text="List of predicted bounding boxes"),
                ),
                ...
                (
                    ...
                    models.JSONField(
                        default=list,
                        help_text="List of matched prediction-GT pairs with IoU scores",
                    ),
                ),
                (
                    "unmatched_predictions",
                    models.JSONField(default=list, help_text="FP predictions"),
                ),
                (
                    "unmatched_ground_truth",
                    models.JSONField(default=list, help_text="FN ground truth"),
                ),
                (
                    "image_precision",
                    models.DecimalField(blank=True, decimal_places=4, max_digits=6, null=True),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="image_processing.imageupload",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "species_name",
                    models.CharField(
                        help_text="Species name (e.g., Chinese Egret)", max_length=100
                    ),
                ),
                (
                    "species_class_id",
                    models.IntegerField(help_text="YOLO class ID for this species"),
                ),
                ("true_positives", models.IntegerField(default=0)),
                ("false_positives", models.IntegerField(default=0)),
                ("false_negatives", models.IntegerField(default=0)),
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=4,
                        help_text="AP@0.5 for this species",
                        max_digits=6,
                        null=True,
                    ),
                ),
                ...
                (
                    "ground_truth_count",
                    models.IntegerField(default=0, help_text="Total GT instances of this species"),
                ),
                (
                    "detected_count",
                    models.IntegerField(default=0, help_text="Total detections for this species"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "model_metrics",
                    models.ForeignKey(
                        ...
                        to="image_processing.modelperformancemetrics",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "actual_species",
                    models.CharField(help_text="Ground truth species", max_length=100),
                ),
                (
                    "predicted_species",
                    models.CharField(
                        help_text="Predicted species (or 'background' for FN)", max_length=100
                    ),
                ),
                (
                    "count",
                    models.IntegerField(
                        default=0,
                        help_text="Number of instances with this actual/predicted combination",
                    ),
                ),
                (
                    "percentage",
