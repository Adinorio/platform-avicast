...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('READING_FILE', 'Reading image file'), ('OPTIMIZING', 'Optimizing image'), ('DETECTING', 'Detecting birds'), ('SAVING', 'Saving results'), ('COMPLETE', 'Processing complete')], default='', max_length=20),
        ),
        migrations.AddField(
            model_name='imageupload',
