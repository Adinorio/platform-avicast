...
from .models import ChartConfiguration, GeneratedReport, ReportTemplate
...
class ChartConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "chart_type", "title", "description")}),
...
class ReportTemplateAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["id", "created_at", "updated_at"]
    fieldsets = (
        ("Basic Information", {"fields": ("name", "report_type", "description")}),
        ("Template Configuration", {"fields": ("template_data",)}),
        ("Status", {"fields": ("is_active",)}),
        (
            "Metadata",
            {"fields": ("created_by", "created_at", "updated_at"), "classes": ("collapse",)},
...
class GeneratedReportAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Report Information", {"fields": ("title", "template", "format")}),
        ("File Details", {"fields": ("file_path", "file_size")}),
        ("Generation Details", {"fields": ("parameters", "generated_by", "generated_at")}),
    )
