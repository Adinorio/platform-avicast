...
class User(AbstractUser):
    ...
    def mark_password_changed(self):
        ...
        self.save(update_fields=['password_changed', 'password_changed_date', 'password_change_required'])
...
class UserActivity(models.Model):
    ...
    @classmethod
    def log_activity(cls, user, activity_type, description, ip_address=None, user_agent=None, 
                     severity=Severity.INFO, metadata=None):
...
class DataRequest(models.Model):
    ...
    request_data = models.JSONField(default=dict, blank=True)  # Store the actual data being requested
    ...
    related_species = models.ForeignKey('fauna.Species', on_delete=models.SET_NULL, null=True, blank=True)
    related_site = models.ForeignKey('locations.Site', on_delete=models.SET_NULL, null=True, blank=True)
